...
export default ActionKey = [
    ...
    {id: 56, key: 'Bachelorette says she‘s falling in love with a contestant (to their face - but already got points for the Bachelorette telling the camera crew/Chris that she‘s falling in love with them +5)', points: 5, category: 'OncePerContestant'},
    {id: 57, key: 'Bachelorette says she‘s falling in love with a contestant (to their face - said to contestant first +15)', points: 15, category: 'OncePerContestant'},
    {id: 58, key: 'Bachelorette says she loves a contestant (not to their face - no points if already said to the contestants face)', points: 15, category: 'OncePerContestant'},
    {id: 59, key: 'Bachelorette says she loves a contestant (to their face - but already got points for the Bachelorette telling the camera crew/Chris that she‘s in love with the contestant +5)', points: 5, category: 'OncePerContestant'},
    {id: 60, key: 'Bachelorette says she loves a contestant (to their face - said to contestant first +20)', points: 20, category: 'OncePerContestant'},
    {id: 61, key: 'Contestant wins season (Leaves with Clare or Tayshia‘s final pick)', points: 25, category: 'OncePerEpisode'},
    {id: 62, key: 'Contestant wins season but they split up before After the Final Rose (in non-Jed-like circumstances)', points: -15, category: 'OncePerEpisode'},
    {id: 63, key: 'Contestant wins season but the Bachelor pulls an Arie/Peter and switches to picking someone else', points: -10, category: 'OncePerEpisode'},
    {id: 64, key: 'Contestant loses season but the Bachelor pulls an Arie/Peter and switches to picking them after proposing to someone else', points: 10, category: 'OncePerEpisode'},
    {id: 65, key: 'Contestant pulls a Jed and wins the season only to reveal they just wanted fame (or some other dick move) and they break up with the bachelor', points: -30, category: 'OncePerEpisode'},
    {id: 66, key: 'First 1-on-1 hot tub date with the Bachelorette', points: 5, category: 'Firsts'},
    {id: 67, key: 'First horseback riding date', points: 5, category: 'Firsts'},
    {id: 68, key: 'First helicopter or plane ride with the Bachelorette', points: 10, category: 'Firsts'},
    {id: 69, key: 'First boat ride with the Bachelorette', points: 10, category: 'Firsts'},
    {id: 70, key: 'First person to meet a member of the Bachelorette’s family (in person or virtually)', points: 18, category: 'Firsts'},
    {id: 71, key: 'First contestant to mention their divorce to the Bachelorette', points: 5, category: 'Firsts'},
    {id: 72, key: 'First contestant to mention their kids to the Bachelorette', points: 8, category: 'Firsts'},
    {id: 73, key: 'First contestant to mention their pet to the Bachelorette', points: 12, category: 'Firsts'},
    {id: 74, key: 'First kiss with the Bachelorette after limo intros end', points: 12, category: 'Firsts'},
    {id: 75, key: 'First person to mention Juan Pablo', points: -5, category: 'Firsts'},
    {id: 76, key: 'First person to mention Benoit', points: -5, category: 'Firsts'},
    {id: 77, key: 'First person to mention Colton', points: -5, category: 'Firsts'},
    {id: 78, key: 'First person to mention JPJ', points: -5, category: 'Firsts'},
    {id: 79, key: 'First bad pun (by definition all puns are bad) during the limo intro', points: 5, category: 'Firsts'},
    {id: 80, key: 'Contestant wears a mask during their limo intro (doesn‘t count as prop/costume)', points: 3, category: 'OncePerEpisode'},
    {id: 81, key: 'Makes a corona joke (in a non-science-denial-way) in their limo intro', points: 5, category: 'OncePerEpisode'},
    {id: 82, key: 'Contestant speaks a foreign language during their limo intro', points: 5, category: 'OncePerEpisode'},
    {id: 83, key: 'Contestant brings a prop to their limo intro', points: 8, category: 'OncePerEpisode'},
    {id: 84, key: 'Contestant wears a costume during their limo intro', points: 10, category: 'OncePerEpisode'},
    {id: 85, key: 'Contestant kisses Bachelorette (on lips) during limo intro - consent is important people', points: -10, category: 'OncePerEpisode'},
    {id: 86, key: 'First solo time with the Bachelorette (after limos)', points: 7, category: 'Firsts'},
    {id: 87, key: 'First contestant to steal the Bachelorette away from another contestant', points: 7, category: 'Firsts'},
    {id: 88, key: 'Contestant receives first impression rose (bonus)', points: 12, category: 'OncePerEpisode'},
    {id: 89, key: 'Contestant refers to the Bachelorette as his “girlfriend”', points: 5, category: 'OncePerEpisode'},
    {id: 90, key: 'Contestant says “I was hoping it would be you/her/the Bachelorette” or “I was hoping for you/her/the Bachelorette”', points: 5, category: 'OncePerEpisode'},
    {id: 91, key: 'Mentions "corona" "covid " "pandemic" "mask" "social distancing" or staying "6 feet" away (in a non-science-denial-way)', points: 5, category: 'OncePerEpisode'},
    {id: 92, key: 'Contestant says someone is “Not here for the right reasons”', points: 10, category: 'OncePerEpisode'},
    {id: 93, key: 'Contestant says someone is “disngenuine/disingenuous ”', points: 10, category: 'OncePerEpisode'},
    {id: 94, key: 'Contestant says “I’m not here to make friends”', points: 10, category: 'OncePerEpisode'},
    {id: 95, key: 'Contestant says corona is a hoax/refuses to wear a mask/general corona denial', points: -10, category: 'OncePerEpisode'},
    {id: 96, key: 'Contestant says: “I’m not ready for marriage” / “I’m not ready to get married” / “I’m not ready to get engaged” / “I’m not ready to be engaged”', points: -12, category: 'OncePerEpisode'},
    {id: 97, key: 'Contestant leaves (no point penalty)', points: 0, category: 'OncePerEpisode'},{id: 1, key: 'Contestant is chosen for a date', points: 5, category: 'MultiplePerEpisode'},
    {id: 2, key: 'Contestant advances/receives rose', points: 10, category: 'MultiplePerEpisode'},
    {id: 3, key: 'Contestant receives rose during a date (bonus)', points: 5, category: 'MultiplePerEpisode'},
    {id: 4, key: 'Contestant gets a word bleeped out', points: 7, category: 'OncePerEpisode'},
    {id: 5, key: 'Contestant is on camera shirtless (not during swimming/beach date)', points: 7, category: 'OncePerEpisode'},
